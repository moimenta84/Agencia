...
<div class="Container">
  ...
  <main class="main-container">
    ...
    <section class="hero">
      ...
      <img src="assets/img/mapa.png" class="mapa-icono" alt="mapa">
            ...
            echo '
              <li>
                <div class="card" tabindex="0">
                  <img src="assets/img/destinies/' . $destino[0] . '" alt="' . $destino[1] . '">
                  <div class="card-content">
                    <h3>' . $destino[1] . '</h3>
                    <a href="reserva.php" class="Bock-Now">Reserva ahora</a>
                  </div>
                </div>
              </li>';
          }
...
<?php include 'includes/footer.php'; ?>dy>
</html>
